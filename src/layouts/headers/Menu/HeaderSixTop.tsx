            ...
            <div className="row">
               <div className="col-lg-6">
                  <div className="tg-header-top-info d-flex align-items-center">
                     ...
                     <Link to="mailto:info@salmanhafeez.com"><i className="mr-5 fa-regular fa-envelope"></i> info@salmanhafeez.com</Link>
                  </div>
               </div>
               <div className="col-lg-6">
                  <div className="tg-header-top-info d-flex align-items-center justify-content-end">
                     <Link to="tel:+923123456789"><i className="fa-sharp fa-regular fa-phone"></i> +92 312 3456 789</Link>
                     <span className="tg-header-dvdr mr-10 ml-10"></span>
